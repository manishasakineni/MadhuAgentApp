...
//    FileName = "<null>";
    ...
    init(UserName:String?,RoleIds:Any?,RoleNames:Any?,Title:String?,GenderType:Any?,VillageName:String?,MandalId:Int?,MandalName:String?,DistrictId:Int?,DistrictName:String?,ProvinceId:Int?,ProvinceName:String?,CountryId:Int?,CountryName:String?,ParentAspNetUserName:String?,ParentAspNetUserFirstName:String?,ParentAspNetUserMidlleName:String?,ParentAspNetUserLastName:String?,PostCode:Int?,AspNetUserId:String?,TitleTypeId:Int?,FirstName:String?,MiddleName:String?,LastName:String?,Phone:String?,Email:String?,GenderTypeId:Int?,DOB:String?,Address1:String?,Address2:String?,Landmark:String?,VillageId:Int?,ParentAspNetUserId:Int?,Id:Int?,IsActive:Bool?, FileExtension:String?, FileLocation:String?, FileName:String?, ProfilePicUrl:String?, CreatedBy:String?,ModifiedBy:String?,Created:String?,Modified:String?) {
