...
//                                    isManualLogin = false
    ...
    func requestPUTURL(strURL:NSString,postParams:NSDictionary,postHeaders:NSDictionary,successHandler:@escaping(_ _result:Any)->Void,failureHandler:@escaping (_ error:String)->Void) -> Void {
        appDelegate = UIApplication.shared.delegate as! AppDelegate
    ...
    func requestDELETEURL(strURL:String,success:@escaping(_ _result:AnyObject)->Void,failure:@escaping(_ error:String) -> Void) {
    ...
    func refreshTokenForLogin(successHandler:@escaping(_ _result:Any)->Void,failureHandler:(_ _error:NSError)->Void) -> Void {
        ...
        if(appDelegate.checkInternetConnectivity()){
            ...
            serviceController.requestPOSTURL(strURL: refreshTokenUrl as NSString, postParams: refreshParams, postHeaders: dictHeaders, successHandler:{(result) in
                DispatchQueue.main.async()
                    {
                        ...
                        if isSuccess == true {
                            ...
                            defaults.set (refreshTokenID, forKey: refreshTokenn)
                ...
                appDelegate.window?.makeToast("app.LoginAlert".localize(), duration:kToastDuration, position:CSToastPositionCenter)
                return
