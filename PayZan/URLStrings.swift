...
let refreshTokenUrl:String = baseUrl.appending("Register/RequestRefreshToken")

let changePasswordUrl:String = baseUrl.appending("Register/ChangePassword")
...
let getAddressbyUserIdUrl:String = baseUrl.appending("Address/GetAddressByUserId/")

let getAddressbyAddressIdUrl:String = baseUrl.appending("Address/GetAddressByAddressId/")

let addressInsertUrl:String = baseUrl.appending("Address/insert")
let addressUpdateUrl:String = baseUrl.appending("Address/update")
let addressDeleteUrl:String = baseUrl.appending("Address/delete/")

let getWalletAmountUrl:String = baseUrl.appending("UserWallet/Get/")
...
let TITLETYPE_API           =  baseUrl + "TypeCdDmts/GetTypeCdDmtsByClassType/"
