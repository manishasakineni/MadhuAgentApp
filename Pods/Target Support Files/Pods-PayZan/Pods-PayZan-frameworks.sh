...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AMPFloatingTextField/AMPFloatingTextField.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Localize/Localize.framework"
